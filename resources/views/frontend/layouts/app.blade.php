...
<head>
    ...
    <title>{{ setting('seo.meta_title', config('app.name')) }}</title>
    <meta name="description" content="{{ setting('seo.meta_description') }}">
    <meta name="keywords" content="{{ setting('seo.meta_keywords') }}">
        ...
        <div class="container-fluid px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-center d-none d-lg-flex" id="mainNavbar">
                <ul class="navbar-nav mx-auto mb-2 mb-lg-0 gap-lg-3 gap-2">
                    <li class="nav-item">
                        <a class="nav-link px-3 @if (request()->routeIs('products.index') || request()->routeIs('products.show')) active @endif"
                            href="{{ route('products.index') }}">
                            Shop
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link px-3" href="{{ route('products.index', ['category' => 'gift-boxes']) }}">
                            Gift Boxes
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link px-3" href="{{ route('products.index', ['category' => 'audiobooks']) }}">
                            Audiobooks
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link px-3 @if (request()->routeIs('about')) active @endif"
                            href="{{ route('about') }}">
                            About
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link px-3 @if (request()->routeIs('blog.index') || request()->routeIs('blog.show') || request()->routeIs('blog.category')) active @endif"
                            href="{{ route('blog.index') }}">
                            Blog
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link px-3 @if (request()->routeIs('contact')) active @endif"
                            href="{{ route('contact') }}">
                            Contact
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link px-3 @if (request()->routeIs('faq')) active @endif"
                            href="{{ route('faq') }}">
                            FAQ
                        </a>
                    </li>
    ...
    <div class="offcanvas offcanvas-start d-lg-none" tabindex="-1" id="mobileOffcanvas"
        ...
        <div class="offcanvas-body">
            <ul class="navbar-nav mb-3">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('products.index', ['category' => 'gift-boxes']) }}">Gift
                        Boxes</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link"
                        href="{{ route('products.index', ['category' => 'audiobooks']) }}">Audiobooks</a>
                </li>
                <li class="nav-item">
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-2 col-md-6">
                    ...
                    <ul class="list-unstyled footer-links">
                        ...
                        <li><a href="{{ route('products.index', ['category' => 'gift-boxes']) }}">Gift Boxes</a></li>
                        <li><a href="{{ route('products.index', ['category' => 'audiobooks']) }}">Audiobooks</a></li>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <ul class="list-unstyled footer-links">
                        ...
                        <li><a href="{{ route('faq') }}#shipping">Shipping Info</a></li>
                        <li><a href="{{ route('faq') }}#returns">Returns</a></li>
                        <li><a href="{{ route('faq') }}#privacy">Privacy Policy</a></li>
                    </ul>
                </div>
